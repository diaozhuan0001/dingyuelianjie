...
let userID = '57764eab-07cd-4fc3-a7b0-8f218ffd889a';

let proxyIP = '';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org'

//let sub = '';// 留空则显示原版内容
let sub = 'yxlp.zzt98.v6.army';// 内置优选订阅生成器，可自行搭建 https://github.com/cmliu/WorkerVless2sub
let subconverter = 'https://zhuan-huan.853977546.workers.dev/';// clash订阅转换后端，目前使用本人的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
